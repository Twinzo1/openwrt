...
m = Map("gdut_drcom", translate("广东工业大学客户端"), translate("Configure gdut-drcom client. Configure gdut-drcom client. Visit the project home: https://github.com/chenhaowen01/gdut-drcom-for-openwrt for help!"))
...
remote_ip = s:option(Value, "remote_ip", translate("Remote ip"), translate("非大学城校区填10.0.3.6"))
remote_ip.datatype="ipaddr"
keep_alive_flag = s:option(Value, "keep_alive1_flag", translate("Keep alive1 flag"))
enable_crypt = s:option(Flag, "enable_crypt", translate("Enable crypt"), translate("5.2.0.P版不需勾选"))
